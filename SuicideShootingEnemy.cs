...
namespace Final_Project
{
    class SuicideShootingEnemy
    {
        ...
        public SuicideShootingEnemy(Texture2D enemyTexture, Vector2 enemyPosition, Texture2D enemyBulletTexture, float enemySpeed, int enemyLife, SpriteManager spriteManager)
        {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            float speedVal = Math.Max(Math.Abs(enemySpeed), Math.Abs(enemySpeed));

            if (player.X < enemyPosition.X)
                enemyPosition.X -= speedVal;
        ...
        private void EnemyShoot(GameTime gameTime)
        {
            ...
            if (shotTimer > timeBetweenShots)
            {
                ...
                enemyBullet.Position = new Vector2((enemyPosition.X + 25) + enemyTexture.Width / 2 - enemyBullet.DrawTexture.Width / 2, this.enemyPosition.Y + 50);
        ...
        public Rectangle collisionRect
        {
            get
            {
                return new Rectangle(
                    ...
                    (int)((enemyTexture.Width - (50 * 2) * .5f)),
                    (int)((enemyTexture.Height - (50 * 2) * .5f)));
            }
        }
